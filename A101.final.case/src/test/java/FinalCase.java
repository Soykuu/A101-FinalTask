...
public class FinalCase<string> {
  ...
  @Before
   ...
   @After
       ...
       @Test
    public void test01_KullanıcıGirilmedenÜrünEkleme() throws InterruptedException //Kuulanıcı girişi yapılmadan
       {
      ...
      driver.switchTo().window(tabs.get(1));
       ...
       @Test
    public void test02_KullanıcıGirişiİleÜrünEkleme() throws InterruptedException {
